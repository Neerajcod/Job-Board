...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        if ($job && !empty($job['email'])) {
            ...
            echo"<script>
            alert('No company email found for the selected job.');
            </script>";
        }
    } else {
        ...
        <main>
            <div class="container my-5 p-5" style="max-width: 700px;">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="application.php?candidate_id=<?php echo $candidate_id; ?>" method="POST" enctype="multipart/form-data" id="job-application-form">
