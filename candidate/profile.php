...
<body>
    <div class="container">
        ...
        <div class="card-header bg-dark text-white text-center rounded-top p-1">
            ...
            <fieldset>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="skill" name="skills" class="form-control p-4" value="<?php echo "{$rows['Skills']}"; ?>" readonly>
                </div>
            </fieldset>
