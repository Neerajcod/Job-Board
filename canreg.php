        ...
        <input type="hidden" name="form_type" value="candidate">
            ...
            <fieldset>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control p-4" id="skillInput" name="skills" class="form-control" required>
                </div>
            </fieldset>
            ...
            <div class="text-center">
                <button type="submit" class="btn btn-secondary w-25" id="editButton">Register</button>
            </div>
        </form>
    </div>
