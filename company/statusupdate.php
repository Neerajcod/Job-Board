<?php
// Include connection only once at the beginning
include "../connection.php";
include 'sendmail.php';  // Include the sendmail.php file for email functionality
        ...
        ></script>
            ...
            $(document).ready(function () {
                $('#search-button').click(function () {
                    const formData = $('#search-form').serialize(); // Serialize form data

                    // Send AJAX request
                    $.ajax({
                        url: 'email.php', // Request sent to search.php
                        type: 'GET',
                        data: formData,
