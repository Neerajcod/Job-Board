    ...
    <div class="card-body p-4">
      ...
      <div class="mb-4">
        ...
        <div class="mb-4">
          ...
          <input type="text" class="form-control p-4" id="businessActivity"  name="activity" placeholder="Describe your business activity" required></input>
        </div>
        
        <div class="mb-4">
          <label for="registeredAddress" class="form-label text-dark fw-semibold">Registered Address</label>
          <input type="text" class="form-control p-4" id="registeredAddress"  name="address" placeholder="Enter registered address" required></input>
        </div>
